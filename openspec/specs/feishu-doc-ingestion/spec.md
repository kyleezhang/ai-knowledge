# Feishu Doc Ingestion Specification

## Purpose

This capability defines how an explicitly provided Feishu document is imported as a local `Source` without bypassing the Source workflow gates.
## Requirements
