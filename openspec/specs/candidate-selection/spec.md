# Candidate Selection Specification

## Purpose

This capability defines the explicit user action that selects a recommended Candidate and converts it into an ingested Source while preserving Candidate/Source boundaries and downstream workflow gates.
